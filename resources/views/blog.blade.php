                    ...
                    <div class="relative w-full">
                        ...
                        <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-5 w-5 mt-1 text-gray-500 dark:text-gray-400" viewBox="0 0 20 20"
                                fill="currentColor">
                        ...
                        <input
                            ...
                            placeholder="Search For Articles" type="text" required="" autocomplete="off"
                            name="search">
                    </div>
                    <div>
                        <button type="submit"
    ...
    <div class="py-4 px-4 mx-auto max-w-screen-xl lg:py-8 lg:px-0">
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            @forelse ($posts as $post)
                <article
                    ...
                    <div class="flex justify-between items-center mb-5 text-gray-500">
                        <div class="flex items-center space-x-4">
                            ...
                            src="{{ asset('storage/' . $post->author->foto_profil) }}"
                                alt="anggi" />
                    ...
                    <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white font-serif"><a
                            href="/blog/{{ $post['slug'] }}">{{ $post->title }}</a></h2>
                            <p class="mb-5 font-light text-gray-500 dark:text-gray-400 font-serif">{{ Str::limit(strip_tags($post['body']), 150) }}</p>
                ...
                {{-- end css flowbite --}}
            @empty
                <div class="md:ml-auto md:mr-[-80px] lg:ml-auto lg:mr-[-290px]"> 
                    <p class=" font-semibold text-xl text-center">Articles Not Found!</p>
                    <a href="/blog" class="block font-medium text-blue-500 hover:underline py-5 text-center">&laquo; Back to Blogs</a>
                </div>
            @endforelse
        </div>
    </div>
